...
#
#       You can find Windows start scripts, the sources for this,
#       and more about it all at https://github.com/gradle/gradle/.
#
##############################################################################
...
if "$cygwin" || "$msys" ; then
    ...
    for arg do
        ...
        # iteration list nor the values of $1, $2, etc. within the loop.
        set -- "$arg" "$@"
